...
export const ENTITY_DISTORTION_SHADER = {
    ...
    vertexShader: `
        ...
        void main() {
            ...
            if (sliceRand > 0.88) {
                float offset = (random(sliceY * glitchTime) - 0.5) * 0.04 * glitchIntensity;
                pos.x += offset;
            }
